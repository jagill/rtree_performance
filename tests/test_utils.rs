...
pub fn read_test_case(name: &str) -> Vec<Geometry> {
    ...
    println!("Loading test case {:?}", filepath);
...
pub fn get_positions_list(name: &str) -> Vec<Vec<Coordinate>> {
...
pub fn make_rectangles_list(positions_list: &[Vec<Coordinate>]) -> Vec<Vec<Rectangle>> {
...
pub fn get_random_rects(rect: Rectangle, n: usize, seed: u64) -> Vec<Rectangle> {
